...
async function upload(file:File){
 ...
 await api('complete',{project_id:projectId,version_id:v.id});localStorage.removeItem(storageKey);message('Upload received. Processing continues if you close this page.');await refreshProject();
}

...
await build({entryPoints:['src/ingestion/worker.ts'],outfile:'dist/ingestion-worker/index.js',bundle:true,format:'esm',target:'es2022',platform:'node',mainFields:['module','main'],external:['cloudflare:workers','node:*']});
